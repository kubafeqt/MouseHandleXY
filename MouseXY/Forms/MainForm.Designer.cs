namespace MouseXY
{
    partial class MainForm
    {
      ...
      private void InitializeComponent()
      {
         ...
         lbStartSecSound = new Label();
         lbPlayStartSeconds = new Label();
         nmStartSecSound = new NumericUpDown();
         lbPlaySecSound = new Label();
         lbPlayLengthSound = new Label();
         nmPlaySecSound = new NumericUpDown();
         btnResetToDefaultSound = new Button();
         btnPlayDefaultSound = new Button();
         cmbSoundType = new ComboBox();
         btnSelectLboxSound = new Button();
         btnPlayLboxSound = new Button();
         lbAvailableSounds = new Label();
         lboxSounds = new ListBox();
         lbSoundsSettings = new Label();
         panelBaseKeysSettings = new Panel();
         lbSelectedBaseKeysSetname = new Label();
         ...
         ((System.ComponentModel.ISupportInitialize)nmStartSecSound).BeginInit();
         ((System.ComponentModel.ISupportInitialize)nmPlaySecSound).BeginInit();
         ...
         panelMain.Size = new Size(197, 335);
         ...
         panelOtherSettings.Location = new Point(14, 530);
         ...
         lbOtherSettings.Size = new Size(108, 19);
         ...
         panelSoundsSettings.Controls.Add(lbStartSecSound);
         panelSoundsSettings.Controls.Add(lbPlayStartSeconds);
         panelSoundsSettings.Controls.Add(nmStartSecSound);
         panelSoundsSettings.Controls.Add(lbPlaySecSound);
         panelSoundsSettings.Controls.Add(lbPlayLengthSound);
         panelSoundsSettings.Controls.Add(nmPlaySecSound);
         panelSoundsSettings.Controls.Add(btnResetToDefaultSound);
         panelSoundsSettings.Controls.Add(btnPlayDefaultSound);
         panelSoundsSettings.Controls.Add(cmbSoundType);
         panelSoundsSettings.Controls.Add(btnSelectLboxSound);
         panelSoundsSettings.Controls.Add(btnPlayLboxSound);
         panelSoundsSettings.Controls.Add(lbAvailableSounds);
         panelSoundsSettings.Controls.Add(lboxSounds);
         panelSoundsSettings.Controls.Add(lbSoundsSettings);
         panelSoundsSettings.Location = new Point(83, 39);
         panelSoundsSettings.Name = "panelSoundsSettings";
         panelSoundsSettings.Size = new Size(771, 485);
         ...
         // btnRefreshSounds
         // 
         btnRefreshSounds.Location = new Point(444, 253);
         btnRefreshSounds.Name = "btnRefreshSounds";
         btnRefreshSounds.Size = new Size(75, 23);
         btnRefreshSounds.TabIndex = 121;
         btnRefreshSounds.Text = "refresh";
         btnRefreshSounds.UseVisualStyleBackColor = true;
         btnRefreshSounds.Click += btnRefreshSounds_Click;
         // 
         // btnOpenSoundsFolder
         // 
         btnOpenSoundsFolder.Location = new Point(576, 137);
         btnOpenSoundsFolder.Name = "btnOpenSoundsFolder";
         btnOpenSoundsFolder.Size = new Size(158, 39);
         btnOpenSoundsFolder.TabIndex = 120;
         btnOpenSoundsFolder.Text = "open sounds folder";
         btnOpenSoundsFolder.UseVisualStyleBackColor = true;
         btnOpenSoundsFolder.Click += btnOpenSoundsFolder_Click;
         // 
         // lbStartSecSound
         // 
         lbStartSecSound.AutoSize = true;
         lbStartSecSound.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
         lbStartSecSound.Location = new Point(446, 187);
         lbStartSecSound.Name = "lbStartSecSound";
         lbStartSecSound.Size = new Size(41, 17);
         lbStartSecSound.TabIndex = 119;
         lbStartSecSound.Tag = "";
         lbStartSecSound.Text = "Start:";
         // 
         // lbPlayStartSeconds
         // 
         ...
         lbPlayStartSeconds.Tag = "";
         lbPlayStartSeconds.Text = "seconds";
         // 
         // nmStartSecSound
         // 
         nmStartSecSound.DecimalPlaces = 1;
         nmStartSecSound.Increment = new decimal(new int[] { 1, 0, 0, 65536 });
         ...
         lbPlaySecSound.Tag = "";
         lbPlaySecSound.Text = "seconds";
         // 
         // lbPlayLengthSound
         // 
         lbPlayLengthSound.AutoSize = true;
         lbPlayLengthSound.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
         lbPlayLengthSound.Location = new Point(444, 138);
         lbPlayLengthSound.Name = "lbPlayLengthSound";
         lbPlayLengthSound.Size = new Size(82, 17);
         lbPlayLengthSound.TabIndex = 115;
         lbPlayLengthSound.Tag = "";
         lbPlayLengthSound.Text = "Play length:";
         // 
         // nmPlaySecSound
         // 
         nmPlaySecSound.DecimalPlaces = 1;
         nmPlaySecSound.Increment = new decimal(new int[] { 1, 0, 0, 65536 });
         nmPlaySecSound.Location = new Point(446, 159);
         ...
         // 
         // btnResetToDefaultSound
         // 
         btnResetToDefaultSound.Location = new Point(576, 91);
         btnResetToDefaultSound.Name = "btnResetToDefaultSound";
         btnResetToDefaultSound.Size = new Size(75, 39);
         btnResetToDefaultSound.TabIndex = 113;
         btnResetToDefaultSound.Text = "reset to default";
         btnResetToDefaultSound.UseVisualStyleBackColor = true;
         btnResetToDefaultSound.Click += btnResetToDefaultSound_Click;
         // 
         // btnPlayDefaultSound
         // 
         btnPlayDefaultSound.Location = new Point(659, 91);
         btnPlayDefaultSound.Name = "btnPlayDefaultSound";
         btnPlayDefaultSound.Size = new Size(75, 39);
         btnPlayDefaultSound.TabIndex = 112;
         btnPlayDefaultSound.Text = "play default";
         btnPlayDefaultSound.UseVisualStyleBackColor = true;
         btnPlayDefaultSound.Click += btnPlayDefaultSound_Click;
         // 
         // cmbSoundType
         // 
         cmbSoundType.DropDownStyle = ComboBoxStyle.DropDownList;
         cmbSoundType.FormattingEnabled = true;
         cmbSoundType.Location = new Point(576, 62);
         ...
         // btnSelectLboxSound
         // 
         btnSelectLboxSound.Location = new Point(444, 103);
         btnSelectLboxSound.Name = "btnSelectLboxSound";
         btnSelectLboxSound.Size = new Size(75, 23);
         btnSelectLboxSound.TabIndex = 110;
         btnSelectLboxSound.Text = "select";
         btnSelectLboxSound.UseVisualStyleBackColor = true;
         btnSelectLboxSound.Click += btnSelectLboxSound_Click;
         // 
         // btnPlayLboxSound
         // 
         btnPlayLboxSound.Location = new Point(444, 70);
         btnPlayLboxSound.Name = "btnPlayLboxSound";
         btnPlayLboxSound.Size = new Size(75, 23);
         btnPlayLboxSound.TabIndex = 109;
         btnPlayLboxSound.Text = "play";
         btnPlayLboxSound.UseVisualStyleBackColor = true;
         btnPlayLboxSound.Click += btnPlayLboxSound_Click;
         // 
         // lbAvailableSounds
         // 
         lbAvailableSounds.AutoSize = true;
         lbAvailableSounds.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
         lbAvailableSounds.Location = new Point(29, 39);
         lbAvailableSounds.Name = "lbAvailableSounds";
         lbAvailableSounds.Size = new Size(118, 17);
         lbAvailableSounds.TabIndex = 108;
         lbAvailableSounds.Tag = "";
         lbAvailableSounds.Text = "Available Sounds:";
         // 
         // lboxSounds
         // 
         lboxSounds.FormattingEnabled = true;
         lboxSounds.ItemHeight = 15;
         lboxSounds.Location = new Point(49, 60);
         lboxSounds.Name = "lboxSounds";
         lboxSounds.Size = new Size(389, 289);
         lboxSounds.TabIndex = 107;
         lboxSounds.SelectedIndexChanged += lboxSounds_SelectedIndexChanged;
         lboxSounds.DoubleClick += lboxSounds_DoubleClick;
         // 
         // lbSoundsSettings
         // 
         lbSoundsSettings.AutoSize = true;
         lbSoundsSettings.Font = new Font("Segoe UI", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
         lbSoundsSettings.Location = new Point(9, 4);
         lbSoundsSettings.Name = "lbSoundsSettings";
         lbSoundsSettings.Size = new Size(118, 19);
         ...
         // 
         panelBaseKeysSettings.Controls.Add(lbSelectedBaseKeysSetname);
         ...
         panelBaseKeysSettings.Size = new Size(39, 26);
         panelBaseKeysSettings.TabIndex = 106;
         panelBaseKeysSettings.Tag = "settingsPanels";
         // 
         // lbSelectedBaseKeysSetname
         // 
         lbSelectedBaseKeysSetname.AutoSize = true;
         lbSelectedBaseKeysSetname.Font = new Font("Segoe UI", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
         lbSelectedBaseKeysSetname.Location = new Point(589, 20);
         lbSelectedBaseKeysSetname.Name = "lbSelectedBaseKeysSetname";
         lbSelectedBaseKeysSetname.Size = new Size(130, 19);
         lbSelectedBaseKeysSetname.TabIndex = 156;
         lbSelectedBaseKeysSetname.Tag = "";
         lbSelectedBaseKeysSetname.Text = "Selected setname:";
         // 
         // lbBaseKeysSettings
         // 
         ...
         lbBaseKeysSettings.Size = new Size(75, 19);
         ...
         lbCreateSetFrom.Size = new Size(117, 19);
         ...
         lbBaseKeysAlternative.Size = new Size(87, 19);
         ...
         lbBaseKeysMain.Size = new Size(46, 19);
         ...
         tbAltMiddleMouseWheelUp.MaxLength = 1;
         ...
         tbAltMiddleMouseWheelDown.MaxLength = 1;
         ...
         tbAltMiddleMouseClick.MaxLength = 1;
         ...
         tbAltRightMouseClick.MaxLength = 1;
         ...
         tbAltLeftMouseClick.MaxLength = 1;
         ...
         lbBaseKeysSetName.Size = new Size(71, 19);
         ...
         cboxMiddleMouseWheelUp.Size = new Size(69, 23);
         ...
         cboxMiddleMouseWheelDown.Size = new Size(69, 23);
         ...
         cboxMiddleMouseClick.Size = new Size(69, 23);
         ...
         cboxRightMouseClick.Size = new Size(69, 23);
         ...
         cboxLeftMouseClick.Size = new Size(69, 23);
         ...
         cboxMoveLeft.Size = new Size(69, 23);
         ...
         cboxMoveRight.Size = new Size(69, 23);
         ...
         cboxMoveDown.Size = new Size(69, 23);
         ...
         cboxMoveUp.Size = new Size(69, 23);
         ...
         tbMiddleMouseWheelUp.MaxLength = 1;
         ...
         tbMiddleMouseWheelDown.MaxLength = 1;
         ...
         tbMiddleMouseClick.MaxLength = 1;
         ...
         lbMiddleMouseWheelUp.Size = new Size(172, 19);
         ...
         lbMiddleMouseWheelDown.Size = new Size(192, 19);
         ...
         lbMiddleMouseClick.Size = new Size(143, 19);
         ...
         lbRightMouseClick.Size = new Size(131, 19);
         ...
         lbLeftMouseClick.Size = new Size(121, 19);
         ...
         lbMoveRight.Size = new Size(87, 19);
         ...
         lbMoveLeft.Size = new Size(77, 19);
         ...
         lbMoveDown.Size = new Size(92, 19);
         ...
         lbSettingsType.Size = new Size(66, 19);
         ...
         ((System.ComponentModel.ISupportInitialize)nmStartSecSound).EndInit();
         ((System.ComponentModel.ISupportInitialize)nmPlaySecSound).EndInit();
      ...
      private NumericUpDown nmPlaySecSound;
      ...
      private Label lbSelectedBaseKeysSetname;
      private Button btnSelectLboxSound;
      private Button btnPlayLboxSound;
      private Label lbAvailableSounds;
      private ListBox lboxSounds;
      private Button btnPlayDefaultSound;
      private ComboBox cmbSoundType;
      private Button btnResetToDefaultSound;
      private Label lbStartSecSound;
      private Label lbPlayStartSeconds;
      private NumericUpDown nmStartSecSound;
      private Label lbPlaySecSound;
      private Label lbPlayLengthSound;
